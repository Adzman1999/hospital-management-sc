...
import PatientsReadMoreModal from "../../../layout/nurse/patient/PatientsReadMoreModal";
import PatientOtherInputModal from "../../../layout/nurse/patient/PatientOtherInputModal";
        ...
        icon={<AccessibleRounded sx={{ fontSize: 30 }} />}>
          ...
          searchResult.map((index) => (
            <ContentGrid item xs={12} md={3.5} position='relative'>
              <Stack direction='row' spacing={1} sx={{ position: "absolute", right: 2, top: 1 }}>
                <PatientOtherInputModal index={index}/>
              </Stack>
              <Stack direction='row' spacing={1} sx={{ position: "absolute", right: 2, bottom: 1 }}>
                <PatientsReadMoreModal index={index} />
              </Stack>
              <Typography
              color='primary'
                variant='h4'
