              ...
              searchResult.map((index) => (
                <ContentGrid item xs={12} md={3.5} position='relative'>
                  <Stack
                    ...
                    {index.xray_result.length === 0 ? (
                      <EmptyModal message='No X-ray result Made Yet' />
                    ) : (
                      <XrayResultReadMoreModal index={index} />
                    )}
                  </Stack>
                  <Typography
                    color='primary'
                  ...
                  <Stack spacing={0.5}>
                    <Typography
                      ...
                      variant='body2'
                      fontWeight={600}>
                      {String(index.firstName).length > 15
                    ...
                    <Typography
                      ...
                      variant='body2'
                      fontWeight={600}>
                      {String(index.middleName).length > 15
